...
<img src="assets/demo.gif" alt="M&A Deal-Flow Platform: the flow on a good run, then the same flow with Break it pressed — every failure path lit in red" width="100%">
